...
weight = getWeight("numberOfBytes", systemId, interval, "Entropy", "NetFlow", attackDate)
detectionBytesNetFlow(start, stop, systemId, frequency, interval, 10, threshold, weight, attackDate)