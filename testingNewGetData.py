...
def kmeansMain(baseFile, systems, start, stop, startCombined, stopCombined, frequency, interval, pathToRawFiles, attackDate):        
    ...
    for systemId in systems:
        ...
        #normal
        kmeansCalculation(silkFile, start, stop, interval, systemId, attackDate)
...
def kmeansMain2(baseFile, systems, start, stop, startCombined, stopCombined, frequency, interval, pathToRawFiles, attackDate):        
    ...
    for systemId in systems:
        ...
        #combined
        clusterFrequency = timedelta(minutes = 30)
        testingSet = makeDataSetKmeansNetFlow(silkFile, startCombined, stopCombined, systemId, clusterFrequency, frequency, interval, attackDate)
        print("Finished with making combined testing data")
...
stop = "2011-01-04 00:00:00"
startCombined = "2011-01-03 00:00:00"
stopCombined = "2011-01-04 00:00:00"
...
stopRFTraining = "2011-02-08 12:00:00"
startRFTesting = "2011-01-03 00:00:00"
stopRFTesting = "2011-01-04 00:00:00"
