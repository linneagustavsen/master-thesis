...
def makeTrainingSet(systemId, if_name, start, stop):
    ...
    #df.to_pickle("Telemetry/RandomForest/Data/RawTestingData.pkl")
    df = pd.read_pickle("Telemetry/RandomForest/Data/RawTestingData.pkl")
    ...
    entropy_df.to_pickle("Telemetry/RandomForest/Data/entropy" + str(start) + ".pkl")
    entropy_df = pd.read_pickle("Telemetry/RandomForest/Data/entropy" + str(start) + ".pkl")  
    ...
    trainingSet.to_pickle("Telemetry/RandomForest/Data/TestingSet.pkl")
