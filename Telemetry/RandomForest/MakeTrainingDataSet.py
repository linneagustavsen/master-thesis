...
def makeTrainingSet(systemId, if_name, start, stop):
    ...
    df = pd.read_pickle("Telemetry/RandomForest/Data/RawTrainingData.pkl")
    ...
    for i in range(len(timeStamps)):
        ...
        curLabel = checkLabel("CorrelationTest/DetectionsWithSeconds.txt", timestamp.strftime("%Y-%m-%d %H:%M:%S"))
    ...
    trainingSet.to_pickle("Telemetry/RandomForest/Data/TrainingSet.pkl")
