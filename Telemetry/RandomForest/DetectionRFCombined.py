...
def detectionRandomForestTelemetry(testingSet, systemId, interval, attackDate):
    ...
    TPf = open(str(q) + "/Combined.TP."+ str(int(interval.total_seconds())) +"secInterval.attack."+str(attackDate)+ "."+str(systemId)+ ".csv", "a")
    ...
    FPf = open(str(q) + "/Combined.FP."+ str(int(interval.total_seconds())) +"secInterval.attack."+str(attackDate)+ "."+str(systemId)+ ".csv", "a")
    ...
    FNf = open(str(q) + "/Combined.FN."+ str(int(interval.total_seconds())) +"secInterval.attack."+str(attackDate)+ "."+str(systemId)+ ".csv", "a")
    ...
    TNf = open(str(q) + "/Combined.TN."+ str(int(interval.total_seconds())) +"secInterval.attack."+str(attackDate)+ "."+str(systemId)+ ".csv", "a")
    ...
    # Load the model
    filename = str(s) + "/RandomForestModel.Combined."+str(systemId)+ ".pkl"
    classifier_RF = pickle.load(open(filename, 'rb'))

    timeStamps = pd.read_pickle(str(r) + "/Combined.Testing."+ str(int(interval.total_seconds())) +"secInterval.attack."+str(attackDate)+ "."+str(systemId)+ ".pkl")["_time"].to_numpy()
