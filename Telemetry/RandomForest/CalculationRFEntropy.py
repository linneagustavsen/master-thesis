...
def calculationsRandomForestTelemetryEntropy(systemId, interval, attackDate):
    ...
    f.write("sTime,eTime,entropy_packet_size_ingress,entropy_rate_packet_size_ingress,entropy_packet_size_egress,entropy_rate_packet_size_egress,real_label")
