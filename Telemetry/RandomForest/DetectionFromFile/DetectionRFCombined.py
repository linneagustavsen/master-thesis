...
'''
def detectionRandomForestCombinedTelemetry(start, stop, systemId, interval, attackDate):
    ...
    alerts = pd.read_csv("Calculations0803/RandomForest/Telemetry/Alerts.Combined."+ str(int(interval.total_seconds())) +"secInterval.attack."+str(attackDate)+ "."+ str(systemId)+ ".csv")
