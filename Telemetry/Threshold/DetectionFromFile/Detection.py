...
'''
def detectionTelemetry(start, stop, systemId, field, threshold, weight, attackDate):
    ...
    attackScores = open(str(r) + "/ScoresAttacks." + str(field)+".attack."+str(attackDate)+ "."+str(systemId)+ ".json", "w")
