...
def detection(start, stop, systemId, if_name, fields):
    f0 = open("Telemetry/Kmeans/Data/Entropy.Cluster0."+ str(systemId) + "." + str(if_name).replace("/","-") + ".csv", "a")
    f1 = open("Telemetry/Kmeans/Data/Entropy.Cluster1."+ str(systemId) + "." + str(if_name).replace("/","-") + ".csv", "a")
    ...
    kmeans = pickle.load(open("Telemetry/Kmeans/Models/MLmodelEntropy.pkl", 'rb'))
