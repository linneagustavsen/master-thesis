...
def plotKmeansFields(start, stop, interval, systemId, attackDate):
    ...
    fig.tight_layout()
    fig.savefig("Plots/Kmeans/Attack"+ fileString+ "/Telemetry/Entropy/Packets.ClusterLabelling."+  str(systemId)+ "."+ str(int(interval.total_seconds())) +"secInterval.png", dpi=300)
    plt.close()
