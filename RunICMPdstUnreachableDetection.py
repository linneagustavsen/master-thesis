...
weight = getWeight("ICMPDstUnreachable", systemId, interval, "Threshold", "NetFlow", attackDate)

icmpDstUnreachableDetection(start, stop, arguments[4], frequency, timedelta(minutes=int(arguments[5])), 10, threshold, weight, attackDate)