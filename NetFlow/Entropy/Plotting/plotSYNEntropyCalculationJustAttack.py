...
def makePlot(y_field, y_fieldName, systemId, interval, attackDate):
    ...
    fig.savefig("Plots/Entropy/Attack"+ fileString+ "/NetFlow/JustAttackPeriod/SYN."+  str(systemId)+ "." + str(y_field)+ "."+ str(int(interval.total_seconds())) +"secInterval.png", dpi=300)
    plt.close()
