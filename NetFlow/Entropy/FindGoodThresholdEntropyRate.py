...
def findGoodThresholdEntropyRate(y_field, systemId, interval, windowSize, attackDate):
...
attackDate="08.03.23"
y_fields = ["dstEntropyRate","srcEntropyRate", "flowEntropyRate", "packetSizeEntropyRate"]
...
for systemId in systems:
    ...
    for interval in intervals:
        ...
        for y_field in y_fields:
            print(y_field)
            findGoodThresholdEntropyRate(y_field, systemId, interval, 10, attackDate)
