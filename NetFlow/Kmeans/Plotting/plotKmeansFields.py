...
def plotKmeansFields(start, stop, clusterFrequency, systemId, attackDate):
    ...
    for i in range(math.ceil(intervalTime)):
        ...
        if clusterLabels["AttackCluster"][0] == 0:
            attackCluster = pd.read_csv("Calculations"+ fileString+ "/Kmeans/NetFlow/Cluster0.attack."+str(attackDate)+ ".stopTime." + stopTime.strftime("%H.%M.%S")+ "."+ str(systemId)+ ".csv")
            ...
            attackCluster = pd.read_csv("Calculations"+ fileString+ "/Kmeans/NetFlow/Cluster1.attack."+str(attackDate)+ ".stopTime." + stopTime.strftime("%H.%M.%S")+ "."+ str(systemId)+ ".csv")
    ...
    fig.tight_layout()
    fig.savefig("Plots/Kmeans/Attack"+ fileString+ "/NetFlow/Fields/Packets.ClusterLabelling."+  str(systemId)+ ".png", dpi=300)
    plt.close()
