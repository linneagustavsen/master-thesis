...
def plotRandomForestFields(interval, systemId, attackDate):
    ...
    alerts = pd.read_csv("Calculations"+ fileString+ "/RandomForest/NetFlow/AlertsNoIP.Fields.attack."+str(attackDate)+ "."+ str(systemId)+ ".csv")
    ...
    #fig.tight_layout()
    fig.savefig("Plots/RandomForest/Attack"+ fileString+ "/NetFlow/Fields/NoIP.Packets."+  str(systemId)+ ".jpg", dpi=300)
    plt.close(fig)
