...
def findGoodThreshold(systemId, intervals, windowSize, attackDate):
    ...
    for interval in intervals:
        ...
        for i in range(len(metricCalc)):
            ...
            for timeInterval in attackIntervals:
                ...
                if sTime[i].replace(second=0) in timeInterval or eTime[i].replace(second=0) in timeInterval:
                    attack = True
                    isThereAttack = True
...
for attackDate in attackDates:
    ...
    for systemId in systems:
        print(systemId)
        findGoodThreshold(systemId, intervals, 10, attackDate)
