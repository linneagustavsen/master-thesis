...
def detection(start, stop, systemId, if_name, fields):
    f0 = open("TelemetryKmeans/Data/Entropy.Cluster0."+ str(systemId) + "." + str(if_name).replace("/","-") + ".csv", "a")
    f1 = open("TelemetryKmeans/Data/Entropy.Cluster1."+ str(systemId) + "." + str(if_name).replace("/","-") + ".csv", "a")
