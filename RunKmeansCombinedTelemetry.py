...
weight = getWeight("Combined", systemId, interval, "Kmeans", "Telemetry", attackDate)

detectionKmeansCombinedTelemetry(start, stop,systemId, interval, clusterFrequency, 0.5, 0, 0, weight, attackDate)