...
capture_file="SYN.pcap"
traceroute_log="SYN_traceroute.log"
attack_stats_log="SYN_stats.log"
attack_log="SYN_attack.log"
...
capture_file="SlowLoris.pcap"
traceroute_log="SlowLoris_traceroute.log"
attack_stats_log="SlowLoris_stats.log"
attack_log="SlowLoris.log"
attack_duration=$((60)) # in seconds
destination_ip=$machine11_ip
destination_port=$machine11_port
...
attack_type="ping"
capture_file="ping.pcap"
traceroute_log="ping_traceroute.log"
attack_stats_log="ping_stats.log"
attack_log="ping.log"
attack_duration=$((60)) # in seconds
destination_ip=$machine11_ip
destination_port=$machine11_port
...
attack_type="RUDY"
capture_file="RUDY.pcap"
traceroute_log="RUDY_traceroute.log"
attack_stats_log="RUDY_stats.log"
attack_log="RUDY.log"
attack_duration=$((60)) # in seconds
destination_ip=$machine11_ip
destination_port=$machine11_port
