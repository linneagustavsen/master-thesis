...
weightDstEntropy = getWeight("dstEntropy", systemId, interval, "Entropy", "NetFlow", attackDate)
weightDstEntropyRate = getWeight("dstEntropyRate", systemId, interval, "Entropy", "NetFlow", attackDate)

detectionDst(start, stop, systemId, frequency, interval, 10, thresholdDstEntropy, thresholdDstEntropyRate, weightDstEntropy, weightDstEntropyRate, attackDate)